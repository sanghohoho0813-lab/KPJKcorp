...
| 검증 | 결과 |
|---|---|
| 001_schema.sql | 표 19개 생성, 오류 0 (NOTICE 만) |
| 002_rls.sql | 정책 40여 개 생성, 오류 0 |
| 003_storage.sql | 버킷 2개 + 정책 6개, 오류 0 |
| 재실행 안전성 | `if not exists` / `drop policy if exists` 로 두 번 돌려도 안전 |
