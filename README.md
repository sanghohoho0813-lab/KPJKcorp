...
- 설계 원본: `PROJECT_SPEC.md` · 진행상황: `PROJECT_STATE.md` · 결정 기록: `DECISIONS.md` · QA: `QA_REPORT.md` · 후속 아이디어: `RECOMMENDATIONS.md`
...
src/app/ax/*             Business AX (대시보드·기업고객·프로젝트·상담/계약·자료·일정·업무·문의·결과·AI 브리핑·리포트·설정·Why AX)
src/app/portal/*         Client Portal (홈·내 프로젝트·요청자료·일정·완료자료·문의·알림·내 정보)
